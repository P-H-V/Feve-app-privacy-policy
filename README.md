...
- **Orthodox Saints' Feasts and Prayers:** Discretionary Spiritual content reflecting traditional Orthodox Christian practices for intercession regarding fertility, safe childbirth, and family life
...
### 6.2 Content Updates
- Recipes and articles are synced from public GitHub repositories
...
- **Delete** all your data (via "Delete All Data" the app menu)
...
Your health data is encrypted and stored locally on your device. However, you are responsible for keeping your device secure and remembering your PIN. If you lose your PIN, your data cannot be recovered. We recommend regular data exports as a backup measure.

## 11. Changes to This Policy

We may update this privacy policy from time to time. We will notify you of any changes by updating the "Last updated" date at the top of this page. The current, authoritative version of this policy is always hosted publicly on this repository page and remains accessible directly via our Google Play Store listing. We encourage users to check this link periodically to stay informed about our data practices.
